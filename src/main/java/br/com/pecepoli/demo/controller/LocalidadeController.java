...
public class LocalidadeController {
    ...
    public ResponseEntity<List<Localidade>> obterLocalidades(@RequestParam(name = "q", required = false) String criteria, Pageable pageable){
    ...
    public ResponseEntity<Localidade> obter (@PathVariable("id") UUID id){
